-- Create automations table with the provided schema
...
-- Insert existing automation data
INSERT INTO public.automations (
  id, title, status, category, platforms, setup_time, complexity, reviews_count, rating, 
...
-- First, drop columns that contain automation data (keeping the link structure)
