-- Manually trigger the order transaction completion for the completed order
-- This should process all fees and create wallet transactions
...
-- Step 3: Create wallet transactions for all completed fees
...
-- Step 4: Create wallet transaction for the payment
INSERT INTO transactions (user_id, type, amount, description, status, order_id)
SELECT 
  ot.user_id, 
  'order_payment', 
